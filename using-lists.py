...
assert users == ['alice', 'kevin'], f"Expected 'users' to be ['alice', 'kevin'] but got: {repr(rev_users)}"
...
assert users == ['alice', 'andy'], f"Expected 'users' to be ['alice', 'andy'] but got: {repr(users)}"